...
const DEFAULT_PET_MESSAGES: &[&str] = &[
    "soft quack. thank you.",
    "tiny duck heart: full.",
    "that was nice. i review better when appreciated.",
    "happy glides. happy quacks.",
    "grateful little duck noises.",
    "you pet. i paddle.",
    "snappy feels seen.",
    "thank you. morale restored.",
    "warm tide, warm heart.",
    "pet accepted. confidence +1.",
];
